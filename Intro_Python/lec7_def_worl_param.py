...
info_user1(login="TSShrol",email="tetiana.shrol@rshu.edu.ua") # 30
info_user1(login="TSShrol",email="tetiana.shrol@rshu.edu.ua",age=38) #38
...
def suma_number_flag(flag=True,*nums):
    ...
    suma_num=0
    for item in nums:
        if flag==True and item%2==0:
            suma_num+=item
        elif flag==False and item%2==1:
            suma_num+=item
    return suma_num
